...
### Barplot
Because the top 2 projectAmounts are too large, they are ploted in one graph. And the others are in another plot.  
...
- Mapping are displayed in two scale:county level and state level. Buttons are at the topeleft of mapping box.       
